...
$('.this-voice').click(function(){
  ...
  hourToApi = $(this).attr('aria-label-term-hour');
...
function get_and_compile_dropdown() {
  ...
  if ( filtro === 'tipo-evento' ) {
    ...
    $('.top-opener-4-txt-replace').html("Fascia oraria").removeClass('txt-3-color');
  }
  ...
  if ( filtro === 'fascia-oraria' ) {
    $('.top-opener-4-txt-replace').html(term_name_trim).addClass('txt-3-color');
    $('.fake-select-4 .top-opener-3-txt-replace').html(term_name).addClass('txt-3-color');
    $('.this-voice').show();
    $('#turn-off-'+term_id).hide();
  ...
  if ( filtro === 'fascia-oraria-remover' ) {
    $('.top-opener-4-txt-replace').html('Fascia oraria').removeClass('txt-3-color');
    $('.fake-select-4 .top-opener-3-txt-replace').html('Fascia oraria').removeClass('txt-3-color');
    $('.this-voice').show();
