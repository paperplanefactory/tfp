...
?>
<div class="picture-fullscreen bg-4-color">
  ...
  <div class="image-holder bg-3-color lazy" data-original="<?php echo $image_attributes[0] ?>" role="img" aria-label="<?php the_title(); ?> | <?php bloginfo( 'name' ); ?>"><div class="lazy-placehoder"></div></div>
