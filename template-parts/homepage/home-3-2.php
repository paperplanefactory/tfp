...
<picture>
  <source media="(max-width: 767px)" srcset="<?php bloginfo('stylesheet_directory'); ?>/images/mosaic/img-mod-4-1.png">
    <source media="(max-width: 1024px)" srcset="<?php bloginfo('stylesheet_directory'); ?>/images/mosaic/img-mod-4-1.png">
      <source media="(min-width: 1025px)" srcset="<?php bloginfo('stylesheet_directory'); ?>/images/mosaic/img-mod-4-1.png">
        <img src="<?php bloginfo('stylesheet_directory'); ?>/images/mosaic/img-mod-4-1.png" title="" alt="" />
      </picture>
