  ...
  <div class="positioner">
    <div class="texts txt-2-color">
      <div class="padder">
        ...
        <h5><?php if( array_intersect( $allowed_roles, $user->roles ) ) { echo $print_status; } ?><a href="<?php echo $tile_url; ?><?php echo $ab_trace; ?>" target="<?php echo $target; ?>" class="wh"><?php the_field( 'titolo_' . $rand_ab ); ?></a></h5>
...
<picture>
  <source media="(max-width: 767px)" srcset="<?php bloginfo('stylesheet_directory'); ?>/images/mosaic/img-mod-7-2-b.png">
    <source media="(max-width: 1024px)" srcset="<?php bloginfo('stylesheet_directory'); ?>/images/mosaic/img-mod-4-2.png">
      <source media="(min-width: 1025px)" srcset="<?php bloginfo('stylesheet_directory'); ?>/images/mosaic/img-mod-4-2.png">
        <img src="<?php bloginfo('stylesheet_directory'); ?>/images/mosaic/img-mod-4-2.png" title="" alt="" />
      </picture>
