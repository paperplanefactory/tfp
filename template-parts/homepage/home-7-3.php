...
?>
<div class="child-content mosaic mosaic-3-b">
...
<picture>
  <source media="(max-width: 767px)" srcset="<?php bloginfo('stylesheet_directory'); ?>/images/mosaic/img-mod-7-2-b.png">
    <source media="(max-width: 1024px)" srcset="<?php bloginfo('stylesheet_directory'); ?>/images/mosaic/img-mod-7-3.png">
      <source media="(min-width: 1025px)" srcset="<?php bloginfo('stylesheet_directory'); ?>/images/mosaic/img-mod-7-3.png">
        <img src="<?php bloginfo('stylesheet_directory'); ?>/images/mosaic/img-mod-7-3.png" title="" alt="" />
      </picture>
