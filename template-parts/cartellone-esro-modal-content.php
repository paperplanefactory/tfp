...
if (get_field('avviso_spettacolo', $p_id)) :
?>
        ...
        <div class="wrapper-padded-more-spettacolo">
            <div class="spettacolo-grid-new">
                                            ...
                                            <div class="flex-hold flex-hold-2">
                                                <div class="flex-hold-child">
                                                    <div class="post-image">
                                                        <!--<img src="<?php the_post_thumbnail_url(); ?>" title="<?php the_title(); ?>" alt="<?php echo get_post_meta($thumb_id, '_wp_attachment_image_alt', true); ?>" />-->
                ...
                <div class="spettacolo-grid-new-right sticked">
                    <div class="overlay-lisiting-padding">
                        <a href="#" class="btn-fill-hover grey cta-4 allupper tickets-overlaty-closer-generic">
                            X Chiudi
                        </a>
                    </div>
                </div>
