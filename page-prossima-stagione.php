<?php
/**
 * Template Name: Prossima stagione
*/

get_header();
//stabilisco la stagione corrente per filtrare gli spettacoli
$stagione_prossima = get_field("scegli_stagione_prossima", "option");
$stagione_prossima_id = get_term_by('id', $stagione_prossima, 'stagione');
$stagione_prossima_name = $stagione_prossima_id->name;
$stagione_prossima_slug = $stagione_prossima_id->slug;
?>
  ...
  <div class="wrapper-padded">
    <div class="fiftyfifty-grid-taxes just-verticalize">
      <div class="fiftyfifty-grid-module-left">
        <h2>Stagione <?php echo $stagione_prossima_name; ?></h2>
      </div>
...
<div class="wrapper pad-top-2 pad-bottom-2">
  <div class="wrapper-padded">
    ...
    $tax_query[] =  array(
      'taxonomy' => 'stagione',
      'field' => 'slug',
      'terms' => $stagione_prossima_slug
    );

      $page = (get_query_var('paged')) ? get_query_var('paged') : 1;
      $args_arch_main = array(
        'post_type' => 'spettacoli_futuri',
        'posts_per_page' => 24,
        'tax_query' => $tax_query,
        'paged' => $page
      );
